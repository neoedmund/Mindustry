...
public class CrawlUnit extends Unit implements Boundedc, Builderc, Crawlc, Drawc, Entityc, Flyingc, Healthc, Hitboxc, Itemsc, Minerc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  ...
  public void update() {
    ...
    crawl: {
        if (moving()) {
            ...
            lastCrawlSlowdown = Mathf.lerp(1.0F, type.crawlSlowdown, Mathf.clamp((float)solids / count / type.crawlSlowdownFrac));
        }

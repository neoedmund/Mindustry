...
public class BuildingTetherPayloadUnit extends Unit implements Boundedc, Builderc, BuildingTetherc, Drawc, Entityc, Flyingc, Healthc, Hitboxc, Itemsc, Minerc, Payloadc, Physicsc, Posc, Rotc, Shieldc, Statusc, Syncc, Teamc, Unitc, Velc, Weaponsc {
  ...
  public String toString() {
    return "BuildingTetherPayloadUnit#" + id;
  }
  ...
  public boolean dropBlock(BuildPayload payload) {
        ...
        if (on != null && Build.validPlace(tile.block, tile.team, tx, ty, tile.rotation, false)) {
            int rot = (int)((rotation + 45.0F) / 90.0F) % 4;
